...
applyLegacyIosStyles = function () {
  // allow different styling if ios 3 or below;
  var agent = window.navigator.userAgent,
  start = agent.indexOf('OS ');
  var version = "";
  if ((agent.indexOf('iPhone') > -1 || agent.indexOf('iPad') > -1) && start > -1) {
    version = agent.substr(start + 3, 3);
  }
  if (parseInt(version.charAt(0)) <= 3) {
    $("html").addClass("legacy-ios");
  }
}
