...
window.Swipe = function(element, options) {
  ...
  this.ratio = 1;
  this.monoSlide = false; // show 1 slide only or the whole slider
...
Swipe.prototype = {
  ...
  slide: function(newindex, duration) {
    ...
    style.MozTransform = style.webkitTransform = 'translate3d(' + -(xPos) + 'px,0,0)';
    style.msTransform = style.OTransform = 'translateX(' + -(xPos) + 'px)';
  ...
  onTouchMove: function(e) {
    ...
    if (!this.isScrolling) {
      ...
      this.element.style.MozTransform = this.element.style.webkitTransform = 'translate3d(' + (this.deltaX - this.currentIndex * this.width) + 'px,0,0)';
  ...
  onTouchEnd: function(e) {
    ...
    // determine if slide attempt is past start and end
        isPastBounds = 
          !this.currentIndex && this.deltaX > 0                          // if first slide and slide amt is greater than 0
          || this.currentIndex == this.length - 1 && this.deltaX < 0;    // or if last slide and slide amt is less than 0

    // if not scrolling vertically
    if (!this.isScrolling) {

      // call slide function with slide end value based on isValidSlide and isPastBounds tests
      this.slide( this.currentIndex + ( isValidSlide && !isPastBounds ? (this.deltaX < 0 ? 1 : -1) : 0 ), this.speed );
